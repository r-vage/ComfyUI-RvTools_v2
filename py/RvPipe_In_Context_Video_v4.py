...
class RvPipe_In_Context_Video_v4:
    def __init__(self):
        pass
...
NODE_NAME = 'Pipe In Context Video v4 [RvTools]'
NODE_DESC = 'Pipe In Context Video v4'

NODE_CLASS_MAPPINGS = {
   NODE_NAME: RvPipe_In_Context_Video_v4
}
