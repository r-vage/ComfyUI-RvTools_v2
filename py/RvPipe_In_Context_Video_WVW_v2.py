...
_all_context_input_output_data = {
  ...
  "model_1": ("model_1", "WANVIDEOMODEL", "model_1"),
  "model_2": ("model_2", "WANVIDEOMODEL", "model_2"),
  "clip_1": ("clip_1", "WANTEXTENCODER", "clip_1"),
  "vae_1": ("vae_1", "WANVAE", "vae_1"),
...
class RvPipe_In_Context_Video_WVW_v2:
    def __init__(self):
        pass
...
NODE_NAME = 'Pipe In Context Video (WVW) v2 [RvTools]'
NODE_DESC = 'Pipe In Context Video (WVW) v2'

NODE_CLASS_MAPPINGS = {
   NODE_NAME: RvPipe_In_Context_Video_WVW_v2
}
