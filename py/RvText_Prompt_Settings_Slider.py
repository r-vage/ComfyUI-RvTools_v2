...
class RvText_Prompt_Settings_Slider:
    ...
    def load_json(self):
        ...
        try:
            ...
            log.error("PromptSettingsSlider", f"Error reading JSON file: {e}")  
    ...
    def get_input_types_from_keys(keys):
        input_types = {}
        for key in keys:
            input_types[key] = (tuple(RvText_Prompt_Settings_Slider.get_options_keys(key)), {"default": "None"})
...
NODE_NAME = 'Prompt Settings Slider [RvTools]'
