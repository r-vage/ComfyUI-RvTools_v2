...
class RvSettings_Sampler_Settings_Flux_NIS:
    def __init__(self):
        pass
    ...
    def execute(self, Sampler, Scheduler, Steps, CFG, Flux_Guidance, Denoise, Sigmas_Denoise, Noise_Strength, Noise_Seed):
...
NODE_NAME = 'Sampler Settings NIS (Flux) [RvTools]'
NODE_DESC = 'Sampler Settings NIS (Flux)'

NODE_CLASS_MAPPINGS = {
   NODE_NAME: RvSettings_Sampler_Settings_Flux_NIS
}
