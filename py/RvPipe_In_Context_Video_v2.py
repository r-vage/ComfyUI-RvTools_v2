...
_all_context_input_output_data = {
  ...
  "model_1": ("model_1", "MODEL", "model_1"),
  "model_2": ("model_2", "MODEL", "model_2"),
  "clip": ("clip", "CLIP", "clip"),
  "vae": ("vae", "VAE", "vae"),
...
class RvPipe_In_Context_Video_v2:
    def __init__(self):
        pass
...
NODE_NAME = 'Pipe In Context Video v2 [RvTools]'
NODE_DESC = 'Pipe In Context Video v2'

NODE_CLASS_MAPPINGS = {
   NODE_NAME: RvPipe_In_Context_Video_v2
}
