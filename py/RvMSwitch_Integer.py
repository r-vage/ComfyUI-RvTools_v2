...
class RvSwitch_Integer_MultiSwitch:
    def __init__(self):
        pass
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "input3": ("INT", {"forceInput": True}),
                "input4": ("INT", {"forceInput": True}),
                "input5": ("INT", {"forceInput": True}),
            }
        }
...
NODE_NAME = 'Integer Multi-Switch [RvTools]'
NODE_DESC = 'Integer Multi-Switch'

NODE_CLASS_MAPPINGS = {
   NODE_NAME: RvSwitch_Integer_MultiSwitch
}
