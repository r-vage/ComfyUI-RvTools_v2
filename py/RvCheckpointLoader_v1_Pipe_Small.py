...
class RvCheckpointLoader_v1_Small_Pipe:
    def __init__(self):
        pass
...
NODE_NAME = 'Checkpoint Loader v1 Small (Pipe) [RvTools]'
NODE_DESC = 'Checkpoint Loader v1 Small (Pipe)'

NODE_CLASS_MAPPINGS = {
   NODE_NAME: RvCheckpointLoader_v1_Small_Pipe
}
